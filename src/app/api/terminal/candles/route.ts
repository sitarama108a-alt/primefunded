 ...
 * Completely removes Twelve Data dependency.
 */
...
const INTERVAL_MAP: Record<string, { binance: string, stooq: string }> = {
  ...
  "4h": { binance: "4h", stooq: "h" }, // Stooq hourly fallback
